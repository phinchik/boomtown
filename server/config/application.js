...
module.exports = app => {
  ...
  app.set('PG_USER', process.env.PG_USER || 'localhost');
  app.set('PG_PASSWORD', process.env.PG_PASSWORD || 'localhost');
  app.set('PG_DB', process.env.PG_DB || 'localhost');
  app.set('JWT_SECRET', process.env.JWT_SECRET || 'localhost');
